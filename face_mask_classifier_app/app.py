...
def mask_image():
    ...
    model = pickle.load(open("https://github.com/Baskar-t/face_mask_classifier_app/blob/main/face_mask_classifier_app/models/svm_classifier_model_initial.sav", 'rb'))
